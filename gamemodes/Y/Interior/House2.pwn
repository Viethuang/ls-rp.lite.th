...
{
    //APARTAMENT BY ADRI1
    //YOU CAN USE MAP MOVER 2.1 TO CHANGE MAP POSITION [http://forum.sa-mp.com/showthread.php?t=606713]

    #define CreateObjectHouse(%0,%1,%2,%3,%4,%5,%6) CreateObject(%0,%1,%2,%3,%4,%5,%6,1000.0)

    new PlayerHouse = CreateObjectHouse(19329, 1517.328491, -1096.024291, 129.009124, 0.000007, 0.000000, 0.000007);
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-50-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-70-percent");
    SetObjectMaterial(PlayerHouse, 1, 18646, "matcolours", "grey-70-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-50-percent");
    SetObjectMaterial(PlayerHouse, 1, 18646, "matcolours", "grey-50-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "black");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-10-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-20-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 18766, "concretebits", "StoneWallTile1-3", -52480);
    ...
    SetObjectMaterial(PlayerHouse, 0, 18646, "matcolours", "grey-40-percent");
    ...
    SetObjectMaterial(PlayerHouse, 0, 19448, "all_walls", "CJ_LIGHTWOOD");
    ...
    SetObjectMaterial(PlayerHouse, 0, 2558, "hospital", "CJ_H_CURTAIN1");
    ...
    SetObjectMaterial(PlayerHouse, 0, 2082, "cj_tables", "CJ_WOOD6");
    ...
    SetObjectMaterial(PlayerHouse, 0, 19378, "all_walls", "mp_diner_woodwall");
    ...
    CreateObjectHouse(1535, 1518.86804, -1100.03418, 128.56900,   0.00000, 0.00000, 180.00000);
    return 1;
}